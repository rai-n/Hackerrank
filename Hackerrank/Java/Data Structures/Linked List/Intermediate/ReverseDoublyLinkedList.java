...
class Result {
    ...
    public static DoublyLinkedListNode reverse(DoublyLinkedListNode head) {
        ...
        while (current != null) {
            // Swapping prev and next references using temporary variable
            temp = current.prev;
            current.prev = current.next;
            current.next = temp;

            // Updating head to go from 1 -> 5 and make 5 the head.
            head = current;
